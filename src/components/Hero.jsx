  ...
  return (
    <section className="bg-white dark:bg-black text-black dark:text-white min-h-screen flex flex-col-reverse lg:flex-row items-center justify-center md:justify-between px-5 lg:px-14 gap-8 pt-5 md:pt-0 transition-colors duration-300">
      ...
      <div className="lg:w-1/2 w-full text-center lg:text-left">
        <div className="inline-flex items-center mb-4 text-orange-400 text-l">
          <FaLeaf className="mr-4" /> People trust us
        </div>
      ...
      <div className="lg:w-1/2 w-full relative flex justify-center mb-10 lg:mb-0">
        ...
        {/* Badges */}
        <div className="absolute top-8 right-0 md:right-10 bg-white text-black text-l px-3 py-1 rounded-full flex items-center shadow-lg">
          <GiFoodTruck className="text-orange-500 mr-2" /> Quality Food
        </div>

        <div className="absolute bottom-10 left-0 md:left-12 bg-white text-black text-l px-3 py-1 rounded-full flex items-center shadow-lg">
          <BsCartCheckFill className="text-green-500 mr-2" /> Easy to Order
        </div>

        <div className="absolute bottom-6 right-0 md:right-10 bg-white text-black text-l px-3 py-1 rounded-full flex items-center shadow-lg">
